...
export class OkuGuzergahService {
    ...
    private resourceSearchUrl = SERVER_API_URL + 'api/_search/oku-guzergahs';
    ...
    /**
     * Convert a returned JSON object to OkuGuzergah.
     */
    private convertItemFromServer(json: any): OkuGuzergah {
        const entity: OkuGuzergah = Object.assign(new OkuGuzergah(), json);
        return entity;
    }

    /**
     * Convert a OkuGuzergah to a JSON which can be sent to the server.
     */
