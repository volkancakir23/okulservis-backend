...
export class OkuOgrenciService {
    ...
    private resourceSearchUrl = SERVER_API_URL + 'api/_search/oku-ogrencis';
    ...
    /**
     * Convert a returned JSON object to OkuOgrenci.
     */
    private convertItemFromServer(json: any): OkuOgrenci {
        const entity: OkuOgrenci = Object.assign(new OkuOgrenci(), json);
        return entity;
    }

    /**
     * Convert a OkuOgrenci to a JSON which can be sent to the server.
     */
